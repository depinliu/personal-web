	    ...
	    <ul class="navbar-nav">
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
	          <a class="dropdown-item" href="<?= base_url()?>portofolio/desain">Desain Grafis</a>
	          <a class="dropdown-item" href="<?= base_url()?>portofolio/web">Web</a>
	        </div>
		      </li>
	      <li class="nav-item">
	      ...
	      <li class="nav-item">
	        <a class="nav-link" target="_blank" href="<?= base_url()?>home/download_cv">Unduh CV</a>
	      </li>
	    </ul>
